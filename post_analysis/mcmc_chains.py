...
def twostarchains(dir_mcmc, dir_out, N_jackknife, prefix, filt, N_burn):
	print("\nStart Analysis")
...
def threestarchains(dir_mcmc, dir_out, N_jackknife, prefix, filt, N_burn):
	print("\nStart Analysis")
	print('----Plotting chains')
	data = np.genfromtxt(dir_mcmc + prefix + filt + '.mcmc')
...
def avg_err_2star(dir_mcmc, dir_out, N_jackknife, prefix, filt, N_burn):
...
def avg_err_3star(dir_mcmc, dir_out, N_jackknife, prefix, filt, N_burn):
	print('----Calculating averages and errors')
