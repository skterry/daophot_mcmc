...
g.plot_2d(samples1,'Separation','Flux_Ratio', filled=False, lims=[881, 911,807,837]) #30 x 30 pixels
g.plot_2d(samples2,'Separation','Flux_Ratio', filled=False, colors=['skyblue'], lims=[881, 911,807,837])
g.settings.num_plot_contours = 2
g.plot_2d(samples2,'Separation','Flux_Ratio', filled=False, colors=['lightblue'], lims=[881, 911,807,837])
g.settings.num_plot_contours = 1
g.plot_2d(samples2,'Separation','Flux_Ratio', filled=False, colors=['white'], lims=[881, 911,807,837])
#g.add_legend(['Ks'],colored_text='Red')
plt.imshow(img)

#plt.text(887, 828, '$Star\ 2\ contour$', fontsize=15, color="black")
#plt.text(898, 817, '$Star\ 1\ contour$', fontsize=15, color="black")
